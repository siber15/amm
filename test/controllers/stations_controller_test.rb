...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { harbour_id: @station.harbour_id, ip: @station.ip, last_seen: @station.last_seen, placement: @station.placement }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { harbour_id: @station.harbour_id, ip: @station.ip, last_seen: @station.last_seen, placement: @station.placement }
    assert_redirected_to station_path(assigns(:station))
  end
